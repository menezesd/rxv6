...
PROGS="init sh cat echo ls wc grep mkdir-cmd rm ln-cmd kill-cmd ed cp mv head-cmd tail-cmd sleep-cmd tee sort uniq od date-cmd true-cmd false-cmd chess"
